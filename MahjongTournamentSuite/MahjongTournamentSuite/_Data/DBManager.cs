...
namespace MahjongTournamentSuite._Data
{
    public class DBManager : IDBManager
    {
        ...
        public void UpdateCountryShortName(string countryName, string newValue)
        {
            _db.Countries.ToList().Find(x => x.CountryName.Equals(countryName)).CountryShortName = newValue;
            _db.SaveChanges();
        }

        public string GetCountryShortName(string playerCountryName)
        {
            return _db.Countries.ToList().Find(x => x.CountryName.Equals(playerCountryName)).CountryShortName;
        }
        ...
        private void EnsureThereAreCountries()
        {
            ...
            {
                _db.Countries.Add(new DBCountry("No Country", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Andorra", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("United Arab Emirates", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Afghanistan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Antigua and Barbuda", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Anguilla", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Albania", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Armenia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Angola", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Argentina", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("American Samoa", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Austria", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Australia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Aruba", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Åland", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Azerbaijan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Bosnia and Herzegovina", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Barbados", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Bangladesh", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Belgium", "BEL", "http://www.mahjongmadrid.com/wp-content/uploads/2016/05/Belgium-32.png"));
                _db.Countries.Add(new DBCountry("Burkina Faso", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Bulgaria", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Bahrain", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Burundi", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Benin", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Bermuda", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Brunei", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Bolivia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Bonaire", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Brazil", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Bahamas", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Bhutan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Botswana", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Belarus", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Belize", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Canada", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Cocos [Keeling] Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Democratic Republic of the Congo", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Central African Republic", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Republic of the Congo", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Switzerland", "SUI", "http://www.mahjongmadrid.com/wp-content/uploads/2016/05/Switzerland-32.png"));
                _db.Countries.Add(new DBCountry("Ivory Coast", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Cook Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Chile", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Cameroon", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("China", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Colombia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Costa Rica", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Cuba", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Cape Verde", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Curacao", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Christmas Island", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Cyprus", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Czechia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Germany", "GER", "http://www.mahjongmadrid.com/wp-content/uploads/2016/05/Flag-of-Germany-32.png"));
                _db.Countries.Add(new DBCountry("Djibouti", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Denmark", "DEN", "http://www.mahjongmadrid.com/wp-content/uploads/2016/05/Denmark-32.png"));
                _db.Countries.Add(new DBCountry("Dominica", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Dominican Republic", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Algeria", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Ecuador", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Estonia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Egypt", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Eritrea", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Spain", "ESP", "http://www.mahjongmadrid.com/wp-content/uploads/2016/05/Flag-of-Spain-32.png"));
                _db.Countries.Add(new DBCountry("Ethiopia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Finland", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Fiji", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Falkland Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Micronesia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Faroe Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("France", "FRA", "http://www.mahjongmadrid.com/wp-content/uploads/2016/05/France-32.png"));
                _db.Countries.Add(new DBCountry("Gabon", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("United Kingdom", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Grenada", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Georgia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Guernsey", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Ghana", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Gibraltar", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Great Britain", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Greenland", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Gambia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Guinea", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Equatorial Guinea", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Greece", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Guatemala", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Guam", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Guinea-Bissau", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Hong Kong", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Honduras", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Croatia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Haiti", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Hungary", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Indonesia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Ireland", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Israel", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Isle of Man", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("India", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("British Indian Ocean Territory", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Iraq", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Iran", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Iceland", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Italy", "ITA", "http://www.mahjongmadrid.com/wp-content/uploads/2016/05/Flag-of-Italy-32.png"));
                _db.Countries.Add(new DBCountry("Jersey", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Jamaica", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Jordan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Japan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Kenya", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Kyrgyzstan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Cambodia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Kiribati", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Comoros", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Saint Kitts and Nevis", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("North Korea", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("South Korea", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Kuwait", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Cayman Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Kazakhstan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Laos", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Lebanon", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Saint Lucia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Liechtenstein", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Sri Lanka", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Liberia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Lesotho", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Lithuania", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Luxembourg", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Latvia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Libya", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Morocco", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Monaco", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Moldova", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Montenegro", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Madagascar", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Marshall Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Macedonia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Mali", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Myanmar", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Mongolia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Macao", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Northern Mariana Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Martinique", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Mauritania", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Montserrat", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Malta", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Mauritius", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Maldives", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Malawi", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Mexico", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Malaysia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Mozambique", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Namibia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Niger", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Norfolk Island", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Nigeria", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Nicaragua", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Netherlands", "NED", "http://www.mahjongmadrid.com/wp-content/uploads/2016/05/Netherlands-32.png"));
                _db.Countries.Add(new DBCountry("Norway", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Nepal", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Nauru", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Niue", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("New Zealand", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Oman", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Panama", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Peru", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("French Polynesia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Papua New Guinea", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Philippines", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Pakistan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Poland", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Pitcairn Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Puerto Rico", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Palestine", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Portugal", "POR", "http://www.mahjongmadrid.com/wp-content/uploads/2016/05/Portugal-32.png"));
                _db.Countries.Add(new DBCountry("Palau", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Paraguay", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Qatar", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Romania", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Serbia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Russia", "RUS", "http://www.mahjongmadrid.com/wp-content/uploads/2017/03/rsz_russia.png"));
                _db.Countries.Add(new DBCountry("Rwanda", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Saudi Arabia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Solomon Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Seychelles", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Sudan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Sweden", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Singapore", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Slovenia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Slovakia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Sierra Leone", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("San Marino", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Senegal", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Somalia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Suriname", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("South Sudan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("São Tomé and Príncipe", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("El Salvador", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Sint Maarten", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Syria", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Swaziland", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Turks and Caicos Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Chad", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Togo", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Thailand", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Tajikistan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Tokelau", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("East Timor", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Turkmenistan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Tunisia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Tonga", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Turkey", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Trinidad and Tobago", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Tuvalu", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Taiwan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Tanzania", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Ukraine", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Uganda", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("United States", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Uruguay", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Uzbekistan", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Vatican City", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Saint Vincent and the Grenadines", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Venezuela", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("British Virgin Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("U.S. Virgin Islands", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Vietnam", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Vanuatu", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Samoa", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Kosovo", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Yemen", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("South Africa", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Zambia", string.Empty, string.Empty));
                _db.Countries.Add(new DBCountry("Zimbabwe", string.Empty, string.Empty));
        ...
        public VEmaPlayer GetEmaPlayer(string playerEmaNumber)
        {
            DBEmaPlayer dbEmaPlayer = _db.EmaPlayers.ToList().Find(x => x.EmaPlayerEmaNumber.Equals(playerEmaNumber));
            return EmaPlayerMapper.GetViewModel(dbEmaPlayer);
        }
