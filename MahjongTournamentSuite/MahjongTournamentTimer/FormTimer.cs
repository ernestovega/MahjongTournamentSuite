...
namespace MahjongTournamentTimer
{
    public partial class MainForm : Form
    {
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            customProgressBarTimer.Maximum = (int)maxTime;
            customProgressBarTimer.Value = 0;
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            timeLeft--;
            lblTime.Text = TimeSpan.FromSeconds(timeLeft).ToString();
            customProgressBarTimer.Value = (int)(maxTime - timeLeft);
        ...
        private void btnMaximize_Click(object sender, EventArgs e)
        {
            if (WindowState != FormWindowState.Maximized)
            {
                ...
                btnMaximize.BackgroundImage = MahjongTournamentTimer.
